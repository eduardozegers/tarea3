...
def runbasic(func, server_address=("127.0.0.1", 8080)):
    """
...
def runsimple(func, server_address=("127.0.0.1", 8080)):
    """
    ...
    #else:
    #print "http://%s:%d/" % server_address
    print "Servicio de Pypotify iniciado en http://localhost:8080"
